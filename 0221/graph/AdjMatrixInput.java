...
/*
 * Node 수가 1000개인 경우까지는.. 여유 있게 인접 행렬로 표시할 수 있기 때문에
 * 데이터가 인접 리스트처럼 link 정보가 입력 되도 행렬로 처리 하면 된다.
 * 
 * link 정보로 주어질 때 주의점
 * ⇒ 그래프가 단방향인 경우 “from → to”만 처리
 * ⇒ 그래프가 무향(양방향)인 경우
 * ⇒ 연결 정보가 1개만 들어오는 경우.. “from → to”, “to → from” 처리를 해야 한다.
 */
