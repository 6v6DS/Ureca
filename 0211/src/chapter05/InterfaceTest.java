...
interface Flyer extends Cloneable{		// interface간에 상속은 extends
	int Type = 1;		//public static final로 선언됨.
	void fly();			// {} 를 넣는 순간 에러가 남. 구현 할 수 없음.		// public abstract로 선언됨.
}
...
class SuperMan extends Human implements Flyer{
	...
	public void fly() {
		System.out.println("하늘을 날아서 지구를 구해야지");				// 이부분 주석 처리하면 바로 error. 
	}																	  // abstract method 이므로 반드시 구현해야함. 반드시 override 받아야 함.
	public void stop() {
